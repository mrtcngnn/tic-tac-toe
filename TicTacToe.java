...
public class TicTacToe extends JFrame implements MouseInputListener, Action {

    private int round = 1; // If it is odd Player 1's turn, if it is even Player 2's turn.
    private static String[][] boardStatus = new String[3][3]; // 3x3 game board.
    private String symbol = "";
    private static int x = 0; // tiklanan yerler
    private static int y = 0;
    private static int locX = 0; // arraydeki yerleri
